...
namespace Dentistry_API.Controllers
{
    ...
    public class PatientsController : ControllerBase
    {
        ...
        public PatientsController(DentistryContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Patient>> PostPatient(Patient patient)
        {
            if (_context.Patients == null)
            {
                return Problem("Entity set 'DentistryContext.Patients'  is null.");
            }
        ...
        //    patient.PasswordPatient = BCrypt.Net.BCrypt.HashPassword(patient.PasswordPatient);
        ...
        //private bool IsPasswordValid(string passwordToCheck, string hashedPassword)
        //{
